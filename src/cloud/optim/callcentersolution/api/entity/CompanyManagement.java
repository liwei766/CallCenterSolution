...
public class CompanyManagement  implements java.io.Serializable {
	...
	// * 企業IDハッシュ */
	/**
	 * @return hashedCompanyId (企業IDハッシュ)
	 */
	...
	*/
	public String toString() {
		...
		buffer.append("hashedCompanyId").append("='").append(getHashedCompanyId()).append("' ");
 ...
 && ( (this.getHashedCompanyId()==castOther.getHashedCompanyId()) || ( this.getHashedCompanyId()!=null && castOther.getHashedCompanyId()!=null && this.getHashedCompanyId().equals(castOther.getHashedCompanyId()) ) )
 ...
 && ( (this.getUpdateUserName()==castOther.getUpdateUserName()) || ( this.getUpdateUserName()!=null && castOther.getUpdateUserName()!=null && this.getUpdateUserName().equals(castOther.getUpdateUserName()) ) );
	...
	public int hashCode() {
		...
		result = 37 * result + ( getHashedCompanyId() == null ? 0 : this.getHashedCompanyId().hashCode() );
