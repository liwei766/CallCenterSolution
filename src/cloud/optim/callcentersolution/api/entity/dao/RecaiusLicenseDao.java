 ...
 * システム名：
 * ソースファイル名：RecaiusLicenseDao.java
 */
...
public class RecaiusLicenseDao {
	 ...
	 */
	public RecaiusLicense get(Serializable id) throws DataAccessException {
		try {
			return (RecaiusLicense)getSession().get(RecaiusLicense.class, id);
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public RecaiusLicense get(Serializable id, LockOptions lockOptions) throws DataAccessException {
		try {
			return (RecaiusLicense)getSession().get(RecaiusLicense.class, id, lockOptions);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public RecaiusLicense load(Serializable id) throws DataAccessException {
		try {
			return (RecaiusLicense)getSession().load(RecaiusLicense.class, id);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public RecaiusLicense load(Serializable id, LockOptions lockOptions) throws DataAccessException {
		try {
			return (RecaiusLicense)getSession().load(RecaiusLicense.class, id, lockOptions);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void load(RecaiusLicense entity, Serializable id) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void refresh(RecaiusLicense entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void refresh(RecaiusLicense entity, LockOptions lockOptions) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public boolean contains(RecaiusLicense entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void evict(RecaiusLicense entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void lock(RecaiusLicense entity, LockOptions lockOptions) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public Serializable save(RecaiusLicense entity) throws DataAccessException {
		try {
			Serializable returnObj = getSession().save(RecaiusLicense.class.getName(), entity);
			flush();
			return returnObj;
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void update(RecaiusLicense entity) throws DataAccessException {
		try {
			getSession().update(RecaiusLicense.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdate(RecaiusLicense entity) throws DataAccessException {
		try {
			getSession().saveOrUpdate(RecaiusLicense.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdate(Collection<RecaiusLicense> entities) throws DataAccessException {
		try {
			for(RecaiusLicense entity : entities) {
				getSession().saveOrUpdate(RecaiusLicense.class.getName(), entity);
			}
			flush();
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void persist(RecaiusLicense entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public RecaiusLicense merge(RecaiusLicense entity) throws DataAccessException {
		try {
			RecaiusLicense returnObj = (RecaiusLicense)getSession().merge(entity);
			flush();
			return returnObj;
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	...
	public void delete(Serializable id) throws DataAccessException {
		try {
			getSession().delete(RecaiusLicense.class.getName(), get(id));
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void delete(RecaiusLicense entity) throws DataAccessException {
		try {
			getSession().delete(RecaiusLicense.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteAll(Collection<RecaiusLicense> entities) throws DataAccessException {
		try {
			for(RecaiusLicense entity : entities) {
				getSession().delete(RecaiusLicense.class.getName(), entity);
			}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public Serializable saveNoFlush(RecaiusLicense entity) throws DataAccessException {
		try {
			Serializable returnObj = getSession().save(RecaiusLicense.class.getName(), entity);
			return returnObj;
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void updateNoFlush(RecaiusLicense entity) throws DataAccessException {
		try {
			getSession().update(RecaiusLicense.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdateNoFlush(RecaiusLicense entity) throws DataAccessException {
		try {
			getSession().saveOrUpdate(RecaiusLicense.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdateNoFlush(Collection<RecaiusLicense> entities) throws DataAccessException {
		try {
			for(RecaiusLicense entity : entities) {
				getSession().saveOrUpdate(RecaiusLicense.class.getName(), entity);
			}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteNoFlush(RecaiusLicense entity) throws DataAccessException {
		try {
			getSession().delete(RecaiusLicense.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteAllNoFlush(Collection<RecaiusLicense> entities) throws DataAccessException {
		try {
			for(RecaiusLicense entity : entities) {
				getSession().delete(RecaiusLicense.class.getName(), entity);
			}
	 ...
	 * @return RecaiusLicense リスト
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public List<RecaiusLicense> findByMap(String queryString, Map<String,Object> paramMap) throws DataAccessException {
		try {
			return applyNamedParameter(createQuery(queryString, RecaiusLicense.class), paramMap).getResultList();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public List<RecaiusLicense> findByNamedQueryAndMap(String queryName, Map<String,Object> paramMap)
			throws DataAccessException {
		try {
			return applyNamedParameter(createNamedQuery(queryName, RecaiusLicense.class), paramMap).getResultList();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	...
	public List<RecaiusLicense> findByExample(Object exampleEntity) throws DataAccessException {
		try {
			return DetachedCriteria.forClass(RecaiusLicense.class).getExecutableCriteria(getSession())
	 ...
	 */
	@SuppressWarnings( "unchecked" )
	public List<RecaiusLicense> findByExample(Object exampleEntity, int firstResult, int maxResults) throws DataAccessException {
		try {
			return DetachedCriteria.forClass(RecaiusLicense.class).getExecutableCriteria(getSession())
				.add(Example.create(exampleEntity))
	...
	protected Criteria createCriteria() {
		Criteria criteria = DetachedCriteria.forClass(RecaiusLicense.class).getExecutableCriteria(getSession());
