 ...
 * システム名：
 * ソースファイル名：VoiceEncodeQueueDao.java
 */
...
/**
 * VoiceEncodeQueueDao クラス
 *
 * @see cloud.optim.callcentersolution.api.entity.VoiceEncodeQueue
 * @author Hibernate Tools
 */
@Repository
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Throwable.class, isolation=Isolation.READ_COMMITTED)
public class VoiceEncodeQueueDao {
	 ...
	 * @return VoiceEncodeQueue
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public VoiceEncodeQueue get(Serializable id) throws DataAccessException {
		try {
			return (VoiceEncodeQueue)getSession().get(VoiceEncodeQueue.class, id);
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public VoiceEncodeQueue get(Serializable id, LockOptions lockOptions) throws DataAccessException {
		try {
			return (VoiceEncodeQueue)getSession().get(VoiceEncodeQueue.class, id, lockOptions);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public VoiceEncodeQueue load(Serializable id) throws DataAccessException {
		try {
			return (VoiceEncodeQueue)getSession().load(VoiceEncodeQueue.class, id);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public VoiceEncodeQueue load(Serializable id, LockOptions lockOptions) throws DataAccessException {
		try {
			return (VoiceEncodeQueue)getSession().load(VoiceEncodeQueue.class, id, lockOptions);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void load(VoiceEncodeQueue entity, Serializable id) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void refresh(VoiceEncodeQueue entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void refresh(VoiceEncodeQueue entity, LockOptions lockOptions) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public boolean contains(VoiceEncodeQueue entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void evict(VoiceEncodeQueue entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void lock(VoiceEncodeQueue entity, LockOptions lockOptions) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public Serializable save(VoiceEncodeQueue entity) throws DataAccessException {
		try {
			Serializable returnObj = getSession().save(VoiceEncodeQueue.class.getName(), entity);
			flush();
			return returnObj;
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void update(VoiceEncodeQueue entity) throws DataAccessException {
		try {
			getSession().update(VoiceEncodeQueue.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdate(VoiceEncodeQueue entity) throws DataAccessException {
		try {
			getSession().saveOrUpdate(VoiceEncodeQueue.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdate(Collection<VoiceEncodeQueue> entities) throws DataAccessException {
		try {
			for(VoiceEncodeQueue entity : entities) {
				getSession().saveOrUpdate(VoiceEncodeQueue.class.getName(), entity);
			}
			flush();
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void persist(VoiceEncodeQueue entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public VoiceEncodeQueue merge(VoiceEncodeQueue entity) throws DataAccessException {
		try {
			VoiceEncodeQueue returnObj = (VoiceEncodeQueue)getSession().merge(entity);
			flush();
			return returnObj;
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	...
	public void delete(Serializable id) throws DataAccessException {
		try {
			getSession().delete(VoiceEncodeQueue.class.getName(), get(id));
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void delete(VoiceEncodeQueue entity) throws DataAccessException {
		try {
			getSession().delete(VoiceEncodeQueue.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteAll(Collection<VoiceEncodeQueue> entities) throws DataAccessException {
		try {
			for(VoiceEncodeQueue entity : entities) {
				getSession().delete(VoiceEncodeQueue.class.getName(), entity);
			}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public Serializable saveNoFlush(VoiceEncodeQueue entity) throws DataAccessException {
		try {
			Serializable returnObj = getSession().save(VoiceEncodeQueue.class.getName(), entity);
			return returnObj;
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void updateNoFlush(VoiceEncodeQueue entity) throws DataAccessException {
		try {
			getSession().update(VoiceEncodeQueue.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdateNoFlush(VoiceEncodeQueue entity) throws DataAccessException {
		try {
			getSession().saveOrUpdate(VoiceEncodeQueue.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdateNoFlush(Collection<VoiceEncodeQueue> entities) throws DataAccessException {
		try {
			for(VoiceEncodeQueue entity : entities) {
				getSession().saveOrUpdate(VoiceEncodeQueue.class.getName(), entity);
			}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteNoFlush(VoiceEncodeQueue entity) throws DataAccessException {
		try {
			getSession().delete(VoiceEncodeQueue.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteAllNoFlush(Collection<VoiceEncodeQueue> entities) throws DataAccessException {
		try {
			for(VoiceEncodeQueue entity : entities) {
				getSession().delete(VoiceEncodeQueue.class.getName(), entity);
			}
	 ...
	 * @return VoiceEncodeQueue リスト
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public List<VoiceEncodeQueue> findByMap(String queryString, Map<String,Object> paramMap) throws DataAccessException {
		try {
			return applyNamedParameter(createQuery(queryString, VoiceEncodeQueue.class), paramMap).getResultList();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public List<VoiceEncodeQueue> findByNamedQueryAndMap(String queryName, Map<String,Object> paramMap)
			throws DataAccessException {
		try {
			return applyNamedParameter(createNamedQuery(queryName, VoiceEncodeQueue.class), paramMap).getResultList();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	...
	public List<VoiceEncodeQueue> findByExample(Object exampleEntity) throws DataAccessException {
		try {
			return DetachedCriteria.forClass(VoiceEncodeQueue.class).getExecutableCriteria(getSession())
	 ...
	 */
	@SuppressWarnings( "unchecked" )
	public List<VoiceEncodeQueue> findByExample(Object exampleEntity, int firstResult, int maxResults) throws DataAccessException {
		try {
			return DetachedCriteria.forClass(VoiceEncodeQueue.class).getExecutableCriteria(getSession())
				.add(Example.create(exampleEntity))
	...
	protected Criteria createCriteria() {
		Criteria criteria = DetachedCriteria.forClass(VoiceEncodeQueue.class).getExecutableCriteria(getSession());
