...
public class KnowledgeTagDao {
	 ...
	 */
	public KnowledgeTag get(Serializable id) throws DataAccessException {
		try {
			return (KnowledgeTag)getSession().get(KnowledgeTag.class, id);
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public KnowledgeTag get(Serializable id, LockOptions lockOptions) throws DataAccessException {
		try {
			return (KnowledgeTag)getSession().get(KnowledgeTag.class, id, lockOptions);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public KnowledgeTag load(Serializable id) throws DataAccessException {
		try {
			return (KnowledgeTag)getSession().load(KnowledgeTag.class, id);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public KnowledgeTag load(Serializable id, LockOptions lockOptions) throws DataAccessException {
		try {
			return (KnowledgeTag)getSession().load(KnowledgeTag.class, id, lockOptions);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void load(KnowledgeTag entity, Serializable id) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void refresh(KnowledgeTag entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void refresh(KnowledgeTag entity, LockOptions lockOptions) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public boolean contains(KnowledgeTag entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void evict(KnowledgeTag entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void lock(KnowledgeTag entity, LockOptions lockOptions) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public Serializable save(KnowledgeTag entity) throws DataAccessException {
		try {
			Serializable returnObj = getSession().save(KnowledgeTag.class.getName(), entity);
			flush();
			return returnObj;
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void update(KnowledgeTag entity) throws DataAccessException {
		try {
			getSession().update(KnowledgeTag.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdate(KnowledgeTag entity) throws DataAccessException {
		try {
			getSession().saveOrUpdate(KnowledgeTag.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdate(Collection<KnowledgeTag> entities) throws DataAccessException {
		try {
			for(KnowledgeTag entity : entities) {
				getSession().saveOrUpdate(KnowledgeTag.class.getName(), entity);
			}
			flush();
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void persist(KnowledgeTag entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public KnowledgeTag merge(KnowledgeTag entity) throws DataAccessException {
		try {
			KnowledgeTag returnObj = (KnowledgeTag)getSession().merge(entity);
			flush();
			return returnObj;
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	...
	public void delete(Serializable id) throws DataAccessException {
		try {
			getSession().delete(KnowledgeTag.class.getName(), get(id));
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void delete(KnowledgeTag entity) throws DataAccessException {
		try {
			getSession().delete(KnowledgeTag.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteAll(Collection<KnowledgeTag> entities) throws DataAccessException {
		try {
			for(KnowledgeTag entity : entities) {
				getSession().delete(KnowledgeTag.class.getName(), entity);
			}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public Serializable saveNoFlush(KnowledgeTag entity) throws DataAccessException {
		try {
			Serializable returnObj = getSession().save(KnowledgeTag.class.getName(), entity);
			return returnObj;
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void updateNoFlush(KnowledgeTag entity) throws DataAccessException {
		try {
			getSession().update(KnowledgeTag.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdateNoFlush(KnowledgeTag entity) throws DataAccessException {
		try {
			getSession().saveOrUpdate(KnowledgeTag.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdateNoFlush(Collection<KnowledgeTag> entities) throws DataAccessException {
		try {
			for(KnowledgeTag entity : entities) {
				getSession().saveOrUpdate(KnowledgeTag.class.getName(), entity);
			}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteNoFlush(KnowledgeTag entity) throws DataAccessException {
		try {
			getSession().delete(KnowledgeTag.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteAllNoFlush(Collection<KnowledgeTag> entities) throws DataAccessException {
		try {
			for(KnowledgeTag entity : entities) {
				getSession().delete(KnowledgeTag.class.getName(), entity);
			}
	 ...
	 * @return KnowledgeTag リスト
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public List<KnowledgeTag> findByMap(String queryString, Map<String,Object> paramMap) throws DataAccessException {
		try {
			return applyNamedParameter(createQuery(queryString, KnowledgeTag.class), paramMap).getResultList();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public List<KnowledgeTag> findByNamedQueryAndMap(String queryName, Map<String,Object> paramMap)
			throws DataAccessException {
		try {
			return applyNamedParameter(createNamedQuery(queryName, KnowledgeTag.class), paramMap).getResultList();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	...
	public List<KnowledgeTag> findByExample(Object exampleEntity) throws DataAccessException {
		try {
			return DetachedCriteria.forClass(KnowledgeTag.class).getExecutableCriteria(getSession())
	 ...
	 */
	@SuppressWarnings( "unchecked" )
	public List<KnowledgeTag> findByExample(Object exampleEntity, int firstResult, int maxResults) throws DataAccessException {
		try {
			return DetachedCriteria.forClass(KnowledgeTag.class).getExecutableCriteria(getSession())
				.add(Example.create(exampleEntity))
	...
	protected Criteria createCriteria() {
		Criteria criteria = DetachedCriteria.forClass(KnowledgeTag.class).getExecutableCriteria(getSession());
