 ...
 * システム名：
 * ソースファイル名：CompanyManagementDao.java
 */
...
/**
 * CompanyManagementDao クラス
 *
 * @see cloud.optim.callcentersolution.api.entity.CompanyManagement
...
public class CompanyManagementDao {
	 ...
	 */
	public CompanyManagement get(Serializable id) throws DataAccessException {
		try {
			return (CompanyManagement)getSession().get(CompanyManagement.class, id);
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public CompanyManagement get(Serializable id, LockOptions lockOptions) throws DataAccessException {
		try {
			return (CompanyManagement)getSession().get(CompanyManagement.class, id, lockOptions);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public CompanyManagement load(Serializable id) throws DataAccessException {
		try {
			return (CompanyManagement)getSession().load(CompanyManagement.class, id);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public CompanyManagement load(Serializable id, LockOptions lockOptions) throws DataAccessException {
		try {
			return (CompanyManagement)getSession().load(CompanyManagement.class, id, lockOptions);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void load(CompanyManagement entity, Serializable id) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void refresh(CompanyManagement entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void refresh(CompanyManagement entity, LockOptions lockOptions) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public boolean contains(CompanyManagement entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void evict(CompanyManagement entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void lock(CompanyManagement entity, LockOptions lockOptions) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public Serializable save(CompanyManagement entity) throws DataAccessException {
		try {
			Serializable returnObj = getSession().save(CompanyManagement.class.getName(), entity);
			flush();
			return returnObj;
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void update(CompanyManagement entity) throws DataAccessException {
		try {
			getSession().update(CompanyManagement.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdate(CompanyManagement entity) throws DataAccessException {
		try {
			getSession().saveOrUpdate(CompanyManagement.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdate(Collection<CompanyManagement> entities) throws DataAccessException {
		try {
			for(CompanyManagement entity : entities) {
				getSession().saveOrUpdate(CompanyManagement.class.getName(), entity);
			}
			flush();
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void persist(CompanyManagement entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public CompanyManagement merge(CompanyManagement entity) throws DataAccessException {
		try {
			CompanyManagement returnObj = (CompanyManagement)getSession().merge(entity);
			flush();
			return returnObj;
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	...
	public void delete(Serializable id) throws DataAccessException {
		try {
			getSession().delete(CompanyManagement.class.getName(), get(id));
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void delete(CompanyManagement entity) throws DataAccessException {
		try {
			getSession().delete(CompanyManagement.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteAll(Collection<CompanyManagement> entities) throws DataAccessException {
		try {
			for(CompanyManagement entity : entities) {
				getSession().delete(CompanyManagement.class.getName(), entity);
			}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public Serializable saveNoFlush(CompanyManagement entity) throws DataAccessException {
		try {
			Serializable returnObj = getSession().save(CompanyManagement.class.getName(), entity);
			return returnObj;
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void updateNoFlush(CompanyManagement entity) throws DataAccessException {
		try {
			getSession().update(CompanyManagement.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdateNoFlush(CompanyManagement entity) throws DataAccessException {
		try {
			getSession().saveOrUpdate(CompanyManagement.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdateNoFlush(Collection<CompanyManagement> entities) throws DataAccessException {
		try {
			for(CompanyManagement entity : entities) {
				getSession().saveOrUpdate(CompanyManagement.class.getName(), entity);
			}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteNoFlush(CompanyManagement entity) throws DataAccessException {
		try {
			getSession().delete(CompanyManagement.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteAllNoFlush(Collection<CompanyManagement> entities) throws DataAccessException {
		try {
			for(CompanyManagement entity : entities) {
				getSession().delete(CompanyManagement.class.getName(), entity);
			}
	 ...
	 * @return CompanyManagement リスト
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public List<CompanyManagement> findByMap(String queryString, Map<String,Object> paramMap) throws DataAccessException {
		try {
			return applyNamedParameter(createQuery(queryString, CompanyManagement.class), paramMap).getResultList();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public List<CompanyManagement> findByNamedQueryAndMap(String queryName, Map<String,Object> paramMap)
			throws DataAccessException {
		try {
			return applyNamedParameter(createNamedQuery(queryName, CompanyManagement.class), paramMap).getResultList();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	...
	public List<CompanyManagement> findByExample(Object exampleEntity) throws DataAccessException {
		try {
			return DetachedCriteria.forClass(CompanyManagement.class).getExecutableCriteria(getSession())
	 ...
	 */
	@SuppressWarnings( "unchecked" )
	public List<CompanyManagement> findByExample(Object exampleEntity, int firstResult, int maxResults) throws DataAccessException {
		try {
			return DetachedCriteria.forClass(CompanyManagement.class).getExecutableCriteria(getSession())
				.add(Example.create(exampleEntity))
	...
	protected Criteria createCriteria() {
		Criteria criteria = DetachedCriteria.forClass(CompanyManagement.class).getExecutableCriteria(getSession());
