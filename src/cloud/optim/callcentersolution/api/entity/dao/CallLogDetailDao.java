 ...
 * システム名：
 * ソースファイル名：CallLogDetailDao.java
 */
...
public class CallLogDetailDao {
	 ...
	 */
	public CallLogDetail get(Serializable id) throws DataAccessException {
		try {
			return (CallLogDetail)getSession().get(CallLogDetail.class, id);
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public CallLogDetail get(Serializable id, LockOptions lockOptions) throws DataAccessException {
		try {
			return (CallLogDetail)getSession().get(CallLogDetail.class, id, lockOptions);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public CallLogDetail load(Serializable id) throws DataAccessException {
		try {
			return (CallLogDetail)getSession().load(CallLogDetail.class, id);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public CallLogDetail load(Serializable id, LockOptions lockOptions) throws DataAccessException {
		try {
			return (CallLogDetail)getSession().load(CallLogDetail.class, id, lockOptions);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void load(CallLogDetail entity, Serializable id) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void refresh(CallLogDetail entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void refresh(CallLogDetail entity, LockOptions lockOptions) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public boolean contains(CallLogDetail entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void evict(CallLogDetail entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void lock(CallLogDetail entity, LockOptions lockOptions) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public Serializable save(CallLogDetail entity) throws DataAccessException {
		try {
			Serializable returnObj = getSession().save(CallLogDetail.class.getName(), entity);
			flush();
			return returnObj;
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void update(CallLogDetail entity) throws DataAccessException {
		try {
			getSession().update(CallLogDetail.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdate(CallLogDetail entity) throws DataAccessException {
		try {
			getSession().saveOrUpdate(CallLogDetail.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdate(Collection<CallLogDetail> entities) throws DataAccessException {
		try {
			for(CallLogDetail entity : entities) {
				getSession().saveOrUpdate(CallLogDetail.class.getName(), entity);
			}
			flush();
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void persist(CallLogDetail entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public CallLogDetail merge(CallLogDetail entity) throws DataAccessException {
		try {
			CallLogDetail returnObj = (CallLogDetail)getSession().merge(entity);
			flush();
			return returnObj;
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	...
	public void delete(Serializable id) throws DataAccessException {
		try {
			getSession().delete(CallLogDetail.class.getName(), get(id));
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void delete(CallLogDetail entity) throws DataAccessException {
		try {
			getSession().delete(CallLogDetail.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteAll(Collection<CallLogDetail> entities) throws DataAccessException {
		try {
			for(CallLogDetail entity : entities) {
				getSession().delete(CallLogDetail.class.getName(), entity);
			}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public Serializable saveNoFlush(CallLogDetail entity) throws DataAccessException {
		try {
			Serializable returnObj = getSession().save(CallLogDetail.class.getName(), entity);
			return returnObj;
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void updateNoFlush(CallLogDetail entity) throws DataAccessException {
		try {
			getSession().update(CallLogDetail.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdateNoFlush(CallLogDetail entity) throws DataAccessException {
		try {
			getSession().saveOrUpdate(CallLogDetail.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdateNoFlush(Collection<CallLogDetail> entities) throws DataAccessException {
		try {
			for(CallLogDetail entity : entities) {
				getSession().saveOrUpdate(CallLogDetail.class.getName(), entity);
			}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteNoFlush(CallLogDetail entity) throws DataAccessException {
		try {
			getSession().delete(CallLogDetail.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteAllNoFlush(Collection<CallLogDetail> entities) throws DataAccessException {
		try {
			for(CallLogDetail entity : entities) {
				getSession().delete(CallLogDetail.class.getName(), entity);
			}
	 ...
	 * @return CallLogDetail リスト
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public List<CallLogDetail> findByMap(String queryString, Map<String,Object> paramMap) throws DataAccessException {
		try {
			return applyNamedParameter(createQuery(queryString, CallLogDetail.class), paramMap).getResultList();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public List<CallLogDetail> findByNamedQueryAndMap(String queryName, Map<String,Object> paramMap)
			throws DataAccessException {
		try {
			return applyNamedParameter(createNamedQuery(queryName, CallLogDetail.class), paramMap).getResultList();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	...
	public List<CallLogDetail> findByExample(Object exampleEntity) throws DataAccessException {
		try {
			return DetachedCriteria.forClass(CallLogDetail.class).getExecutableCriteria(getSession())
	 ...
	 */
	@SuppressWarnings( "unchecked" )
	public List<CallLogDetail> findByExample(Object exampleEntity, int firstResult, int maxResults) throws DataAccessException {
		try {
			return DetachedCriteria.forClass(CallLogDetail.class).getExecutableCriteria(getSession())
				.add(Example.create(exampleEntity))
	...
	protected Criteria createCriteria() {
		Criteria criteria = DetachedCriteria.forClass(CallLogDetail.class).getExecutableCriteria(getSession());
