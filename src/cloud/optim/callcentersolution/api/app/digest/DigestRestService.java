...
import cloud.optim.callcentersolution.api.recaius.result.DigestResult;
...
import cloud.optim.callcentersolution.api.recaius.service.RecaiusDigestService;
...
public class DigestRestService
{
	...
	public DigestResponse digest(DigestRequest req) {
		...
		try {
			...
			digestService.registUseTime(result.getTime(), customUser.getCompanyId(), customUser.getUserId(), customUser.getUserName());
