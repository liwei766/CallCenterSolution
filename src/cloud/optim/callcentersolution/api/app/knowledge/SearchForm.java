...
public class SearchForm implements java.io.Serializable {
	...
	/** 検索条件 */
	private KnowledgeSearchForm knowledge;
	 ...
	 * @return knowledge
	 */
	public KnowledgeSearchForm getKnowledge() { return knowledge; }
	 ...
	 */
	public void setKnowledge( KnowledgeSearchForm knowledge ) { this.knowledge = knowledge; }
}
