...
import cloud.optim.callcentersolution.api.app.agency.AgencyResponse.BulkResult;
import cloud.optim.callcentersolution.api.app.agency.AgencyResponse.EditResult;
...
public class AgencyRestService {
  ...
  public AgencyResponse get(AgencyRequest req) {
    ...
    try {
      ...
      // ----- 取得
      Agency entity =
          agencyService.getAgency(agency.getAgencyId());
      if (entity == null) {
