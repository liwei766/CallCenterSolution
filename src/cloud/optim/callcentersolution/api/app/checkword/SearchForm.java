...
public class SearchForm implements java.io.Serializable {
	...
	/** 検索条件 */
	private CheckwordSearchForm checkword;
	 ...
	 * @return checkword
	 */
	public CheckwordSearchForm getCheckword() { return checkword; }
	 ...
	 */
	public void setCheckword( CheckwordSearchForm checkword ) { this.checkword = checkword; }
}
