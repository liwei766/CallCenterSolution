...
public class CompanyManagementResponse implements java.io.Serializable {
  ...
  public static final class EditResult implements java.io.Serializable {
     ...
     */
    public final String getInquiryFormUrl() {
      return this.inquiryFormUrl;
    }

    /**
     * inquiryFormUrl 設定.
     *
     * @param inquiryFormUrl inquiryFormUrl に設定する値.
     */
    public void setInquiryFormUrl(final String inquiryFormUrl) {
      this.inquiryFormUrl = inquiryFormUrl;
    }
