 ...
 *
 */
package cloud.optim.callcentersolution.core.modules.rest;
...
//	FILE_ERROR_MOVE( "21_00_508" ),
	...
	/** ナレッジタイトル重複 */
	KNOWLEDGE_DUPLICATE_TITLE ( "21_01_001" ),

	/** CSVフォーマットエラー */
	KNOWLEDGE_CSV_FORMAT_ERROR ( "21_01_002" ),
	...
	/** 代理店企業ID重複エラー */
	INQUIRY_FORM_DUPLICATE_HASHED_COMPANY_ID("21_11_001"),

	// ---------- 通話ログ ----------

	/** 通話ログダウンロード音声なし */
	CALL_LOG_DWONLOAD_NO_VOICE("21_12_001"),

	/** 音声ファイルマージ失敗 */
	CALL_LOG_DWONLOAD_FAIL_MERGE("21_12_002"),

	/** 通話ログダウンロードファイルID不正 */
	CALL_LOG_DWONLOAD_INVALID_FILE_ID("21_12_003"),


	// ---------- チェックワード ----------

	/** CSVフォーマットエラー */
	CHECKWORD_CSV_FORMAT_ERROR ( "21_13_001" ),
	CHECKWORD_CSV_REPEAT ( "21_13_002" ),
